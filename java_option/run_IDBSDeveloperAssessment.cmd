...
# It assumes that the cmd file is located in the same directory/folder as the IDBSDeveloperAssessment.jar

java -cp ".\IDBSDeveloperAssessment.jar;" com.idbs.devassessment.core.IDBSDeveloperAssessmentMain
